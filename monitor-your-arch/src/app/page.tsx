            ...
            <div className="flex flex-col w-full just gap-12">
                <div className="flex-1 flex-col items-center justify-center">
                    <div className="flex-1 flex-col -mx-10 -my-14">
                        <div>
                            <p className="font-thin text-xl"> Hello, </p>
                        </div>
                        <div>
                            <p className="font-medium text-xl"> {localStorage.getItem('userName')}</p>
                        </div>
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex justify-center">
                        <Carousel className="w-full ml-24 "
                            plugins={[
                                Autoplay({
                                    delay: 5000,
                                }),
...
>
                            <CarouselContent className="-ml-1">
                                    <CarouselItem key={"paolo"} className="pl-1 md:basis-1/2 lg:basis-1/3">
                                        <div className="p-1">
                                            <Card>
                                    ...
                                    <div className="p-1">
                                        <Card>
                                            <CardContent className="flex aspect-square p-6">
                                                <div className="flex flex-col">
                                                    <span className="text-2xl font-semibold">Real-time network chart</span>
                                                    <p>Ciao</p>
                                                </div>
                                            </CardContent>
                                        </Card>
